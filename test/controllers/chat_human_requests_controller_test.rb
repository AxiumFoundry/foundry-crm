...
class ChatHumanRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "marks conversation as wanting human with contact info and renders turbo stream" do
    ...
    post chat_human_requests_path,
      params: { contact_name: "Jane Doe", contact_email: "jane@example.com" },
      as: :turbo_stream
    assert_response :success
    ...
    assert_equal "Jane Doe", updated_conversation.contact_name
    assert_equal "jane@example.com", updated_conversation.contact_email
  end
