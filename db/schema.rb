...
ActiveRecord::Schema[8.1].define(version: 2026_02_08_200001) do
  ...
  create_table "crm_inquiries", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["contact_id"], name: "index_crm_inquiries_on_contact_id"
  end
  ...
  add_foreign_key "crm_inquiries", "contacts"
